...
export default function Home() {
  return (
    <Layout>
      ...
      <Box>
        <h1 className="text-3xl font-bold text-black font-mono">Nos projets à Akuna Lab</h1>
      </Box>
      <Box bg="bg-red-400">
        <h1 className="text-3xl font-bold text-black font-mono">Nos équipements</h1>
